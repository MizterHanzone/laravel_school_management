        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">School blue</span>
            </a>
            <div class="sidebar">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('academic_year.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('annoucement.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Annoucement</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('annoucement.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add annoucement</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('assign_subject.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Assign Subject</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('assign_subject.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
